...
param definitionName string = 'static-web-app-public-network-access'

var policyDefinitionJson = loadJsonContent('../../definitions/static-web-app-public-network-access.json')
...
module policyAssignment '../modules/assignment-module.bicep' = {
  ...
  params: {
    assignmentName: 'static-web-app-public-network-access'
