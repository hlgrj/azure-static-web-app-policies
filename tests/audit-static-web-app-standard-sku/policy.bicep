...
param definitionName string = 'audit-static-web-app-standard-sku'

var policyDefinitionJson = loadJsonContent('../../definitions/audit-static-web-app-standard-sku.json')
...
module policyAssignment '../modules/assignment-module.bicep' = {
  ...
  params: {
    assignmentName: 'audit-static-web-app-standard-sku'
